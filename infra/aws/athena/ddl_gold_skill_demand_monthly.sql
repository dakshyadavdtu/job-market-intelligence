-- Modular layout: gold/skill_demand_monthly/source=<source>/ingest_month=.../run_id=.../part-00001.parquet
-- (table-first under LOCATION). Partition projection: source, ingest_month, run_id.
-- Migration: copy legacy keys gold/skill_demand_monthly/ingest_month=.../run_id=... to
--   gold/skill_demand_monthly/source=arbeitnow/ingest_month=.../run_id=... (see docs/MIGRATION_V1_V2.md).
