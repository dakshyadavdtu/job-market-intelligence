-- Gold v2 presentation: normalized monthly skill demand (derived from gold/skill_demand_monthly).
CREATE EXTERNAL TABLE IF NOT EXISTS jmi_gold.presentation_skill_demand_monthly (
  skill string,
  job_count bigint,
...
STORED AS PARQUET
LOCATION 's3://jmi-dakshyadav-job-market-intelligence/gold_v2/presentation/v2_skill_demand/monthly/'
TBLPROPERTIES (
