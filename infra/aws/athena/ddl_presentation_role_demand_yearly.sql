CREATE EXTERNAL TABLE IF NOT EXISTS jmi_gold.presentation_role_demand_yearly (
  role string,
  job_count bigint,
...
STORED AS PARQUET
LOCATION 's3://jmi-dakshyadav-job-market-intelligence/gold_v2/presentation/v2_role_demand/yearly/'
TBLPROPERTIES (
