CREATE EXTERNAL TABLE IF NOT EXISTS jmi_gold.presentation_location_demand_monthly (
  location string,
  job_count bigint,
...
STORED AS PARQUET
LOCATION 's3://jmi-dakshyadav-job-market-intelligence/gold_v2/presentation/v2_location_demand/monthly/'
TBLPROPERTIES (
